...
alter table chats add column icon_url text;
alter table chats add column created_by uuid references auth.users on delete set null;
...
create table notifications (
  ...
  type text not null check (type in ('follow', 'friend_accept', 'friend_reject', 'unfollow', 'unfriend', 'like')),
...
create policy "Tags gestionables solo por service_role"
  on tags for all
  to service_role
  using (true)
  with check (true);
...
create policy "Post tags gestionables solo por service_role"
...
create policy "User tag preferences gestionables solo por service_role"
